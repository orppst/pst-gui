...
export type SubmittedProposalResourceGetAssignedSubmittedProposalsPathParams = {
  /**
   * @format int64
   */
  cycleCode: number;
...
export type SubmittedProposalResourceGetAssignedSubmittedProposalsError =
  Fetcher.ErrorWrapper<undefined>;

export type SubmittedProposalResourceGetAssignedSubmittedProposalsResponse =
  Schemas.ObjectIdentifier[];

export type SubmittedProposalResourceGetAssignedSubmittedProposalsVariables = {
  pathParams: SubmittedProposalResourceGetAssignedSubmittedProposalsPathParams;
} & ProposalToolContext["fetcherOptions"];

export const fetchSubmittedProposalResourceGetAssignedSubmittedProposals = (
  variables: SubmittedProposalResourceGetAssignedSubmittedProposalsVariables,
  signal?: AbortSignal,
) =>
  proposalToolFetch<
    SubmittedProposalResourceGetAssignedSubmittedProposalsResponse,
    SubmittedProposalResourceGetAssignedSubmittedProposalsError,
    undefined,
    {},
    {},
    SubmittedProposalResourceGetAssignedSubmittedProposalsPathParams
  >({
    url: "/pst/api/proposalCycles/{cycleCode}/submittedProposals/assignedTo/{personId}",
    method: "get",
    ...variables,
    signal,
  });

export const useSubmittedProposalResourceGetAssignedSubmittedProposals = <
  TData = SubmittedProposalResourceGetAssignedSubmittedProposalsResponse,
>(
  variables: SubmittedProposalResourceGetAssignedSubmittedProposalsVariables,
  options?: Omit<
    reactQuery.UseQueryOptions<
  ...
  >({
    queryKey: queryKeyFn({
      path: "/pst/api/proposalCycles/{cycleCode}/submittedProposals/assignedTo/{personId}",
      operationId: "submittedProposalResourceGetAssignedSubmittedProposals",
      variables,
    }),
    queryFn: ({ signal }) =>
      fetchSubmittedProposalResourceGetAssignedSubmittedProposals(
        { ...fetcherOptions, ...variables },
        signal,
      ),
    ...options,
